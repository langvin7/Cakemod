...
/* [HarmonyPatch(typeof(SetupStrike), MethodType.Constructor)]
public class SetupStrikeConstructorPatch
{
    [HarmonyTranspiler]
...
[HarmonyPatch(typeof(SetupStrike), "CanonicalVars", MethodType.Getter)]
public static class SetupStrikeCanonicalVarsPatch
{
...
public static class SetupStrikeKeywordPatch
{
...
[HarmonyPatch(typeof(SetupStrike), "ExtraHoverTips", MethodType.Getter)]
public static class SetupStrikeExtraHoverTipsPatch
{
...
[HarmonyPatch(typeof(SetupStrike), "OnPlay")]
public static class SetupStrikeOnPlayPatch
{
    [HarmonyPrefix]
    public static bool Prefix(SetupStrike __instance, PlayerChoiceContext choiceContext, CardPlay cardPlay, ref Task __result)
    {
        __result = PatchedOnPlay(__instance, choiceContext, cardPlay);
        return false;
    }

    private static async Task PatchedOnPlay(SetupStrike __instance, PlayerChoiceContext choiceContext, CardPlay cardPlay)
    {
		...
		await PowerCmd.Apply<DrawAttacksNextTurnPower>(__instance.Owner.Creature, __instance.DynamicVars.Cards.BaseValue, __instance.Owner.Creature, __instance);
    }
}


[HarmonyPatch(typeof(SetupStrike), "OnUpgrade")]
public static class SetupStrikeOnUpgradePatch
{
    [HarmonyPrefix]
    public static bool Postfix(SetupStrike __instance)
    {
